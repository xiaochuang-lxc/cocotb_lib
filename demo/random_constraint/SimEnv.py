...
# Source,Sink定义 
#==========================================================================================
item_map={"data0":(0,16,True),"data1":(16,16,True)}

class DataTransactoin(StreamExtRandomTransaction):
    _itemMap={"data0":(0,16,True),"data1":(16,16,True)}

    @vsc.constraint
    def ab_c(self):
        self.data0 + self.data1 == 16384
    

DataBus,DataSource,DataSink,DataMonitor=define_streamext_with_rand_transaction(name="Data",transaction=DataTransactoin)
#==========================================================================================
# SimEnv
#==========================================================================================
class SimEnv(object):
